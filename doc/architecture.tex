...
\mathbf{Laurent} \ar[r, "\text{Smooth}"] \ar[dr, bend right=15, "\text{Forms}"'] & \mathbf{Felix} \ar[d, "\text{Diff}"] & \mathbf{Ulrik} \ar[ul, dashed, "\text{Core}"'] \ar[l, red, bend left=15, "\text{STT}"] \ar[dl, red, bend left=15, "\text{STT}"] \\
& \mathbf{Jack} \ar[d, "\text{Urs}"] & \\
& \mathbf{Urs}\ \text{(Cosmic Cube)} & 
\end{tikzcd}
\end{center}
