...
\begin{abstract}
In this article, we investigate the conjecture that no single formal language can serve as a universal
...
directed-homotopy backbone for Urs's 3-layer architecture. Finally, we construct syntactic CW-complexes
and chain complexes for each language individually, define their cohomology groups,
and assemble a spectral sequence over the full lattice of language categories, providing
a rigorous mathematical framework for this multi-language foundation.
\end{abstract}
