...
(\textbf{Frank}--\textbf{Christine}--\textbf{Laurent}), a homotopical and cohesive spine in the center
...
\begin{itemize}
    ...
    \item \textbf{Homotopical Presheaves:} Bridging the gap from strict 1-categories to full $\infty$-categories, Thierry Coquand's Groupoid-Valued Presheaf models ($\mathbf{Grpd}\text{-}\mathbf{PSh}$) provide a concrete constructive semantics for univalence, where dependent types are interpreted via the \emph{Grothendieck Construction}. This establishes the semantic foundation for Cubical Type Theory.
