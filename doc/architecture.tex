...
(\textbf{Henk}--\textbf{Per}--\textbf{Anders}--\textbf{Urs}), and an operational directed Spine
...
\subsection{Frank: Minimal CIC \cite{Pfenning89}}
...
\subsection{Christine: Full CIC (CwF/CwA) \cite{paulinmohring}}
...
\subsection{Laurent: Calculus and Functional Analysis \cite{laurent05semantics}}
...
\subsection{Henk: Pure Type Systems (PTS) \cite{Henk93}}
...
\subsection{Per: Martin-L\"of Type Theory (MLTT-80) \cite{Lof84}}
...
\newpage
\subsection{Anders: Cubical HoTT \cite{cchm}}
...
\newpage
\subsubsection{Felix (Layer I) \cite{schreibershulman12cohesive}}
...
\subsubsection{Jack (Layer II) \cite{schreiber13differential}}
...
\subsection{Dan: Operational Algebra \cite{birkedal2011first}}
...
\subsection{Mike: Directed 1-Category Type Theory \cite{Shulman15}}
...
\newpage
\subsection{Ulrik: Simplicial \texorpdfstring{$\infty$}{Infinity}-Categories \cite{riehl2017type}}
...
\bibitem[Lau05]{laurent05semantics}
Olivier Laurent.
\newblock Syntax vs. semantics: a polarized approach.
\newblock {\em Theoetical. Computer Science}, 343(1-2):177--206, 2005.
