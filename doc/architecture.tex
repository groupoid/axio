...
& \mathbf{Henk} \ar[d, "\text{+0,1,2,W}"] \ar[dl, bend right=15, "\text{Ind}"'] \ar[dr, bend left=15, "\text{extract}"] & \\
\mathbf{Frank} \ar[d, "\text{+Id,Fix}"'] & \mathbf{Per} \ar[d] \ar[l, "\text{W $\rightarrow$ Ind}"] \ar[r, bend left=15, "\text{extract}"] & \mathbf{Dan} \ar[d, dashed, "\text{Lift}"] \\
...
\subsection{Laurent: Calculus and Functional Analysis \cite{laurent05semantics}}\footnote{\url{https://laurent.groupoid.space}}
...
\subsubsection{Urs (Layer III)}\footnote{\url{https://urs.groupoid.space}}
...
\newpage
\subsection{Ulrik: Simplicial \texorpdfstring{$\infty$}{Infinity}-Categories \cite{riehl2017type}}\footnote{\url{https://ulrik.groupoid.space}}
