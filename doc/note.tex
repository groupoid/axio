...
\hline
\textbf{I. Urs.SupSmth} & \texttt{graded, flat, sharp, bose,} &
    Bose/Fermi grades, $\flat$, $\sharp$, \\
 & \texttt{fermi, tensor, smth, supsmth} &
    $A \otimes B$, SmthSet, SupSmthSet \\
\hline
\textbf{II. Urs.DiffK} & \texttt{spectra, grpd, form,} &
    Spectrum, Susp, Grpd, $\Omega^n(X)$, \\
 & \texttt{ku, diff, diffku} &
    $KU^{\tau}_G$, $d$, DiffKU \\
\hline
\textbf{III. Urs.Quantum} & \texttt{conf, braid, qubit, linear} &
...
4a & Urs.SupSmth & CTT/Modal & + $\flat$, $\sharp$, $\Im$, $\otimes$, Plot & 10 \\
4b & Urs.DiffK & CTT/Modal & + Spectra, Susp, Grpd, Forms, DiffKU & 12 \\
4c & Urs.Quantum & CTT/Modal & + Qubit, Linear, Config, Braid & 7 \\
\hline
